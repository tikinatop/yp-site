        ...
        data.forEach(function(seed){
            Hotel.create(seed,function(err,hotel){
                if (err) {
                    ...
                    console.log("Added a new hotel: " + hotel.nom);
                    Commentaire.create({
